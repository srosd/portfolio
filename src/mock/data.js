...
export const aboutData = {
  ...
  paragraphOne:
    'Interested in a Web Development job that keeps me growing not only professionally but also in a personal way. Preference for team projects and environments that value the importance of a nice job atmosphere.',
  paragraphTwo:
